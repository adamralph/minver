    ...
    internal static class Program
    {
        ...
        private static int Main(string[] args)
        {
            ...
            app.OnExecute(() =>
            {
                ...
                var version = GetVersion(repoOrWorkDir, tagPrefixOption.Value(), minMajorMinor, buildMetaOption.Value(), defaultPrereleaseIdentifiers, verbosity);
        ...
        private static Version GetVersion(string repoOrWorkDir, string tagPrefix, MajorMinor minMajorMinor, string buildMeta,  IEnumerable<string> preReleaseIdentifiers, Verbosity verbosity)
        {
            ...
            {
                var version = new Version(minMajorMinor?.Major ?? 0, minMajorMinor?.Minor ?? 0, buildMeta, preReleaseIdentifiers);
            ...
            try
            {
                return Versioner.GetVersion(repo, tagPrefix, minMajorMinor, buildMeta, preReleaseIdentifiers, log);
            }
            finally
            {
                repo.Dispose();
