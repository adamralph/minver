...
namespace MinVerTests.Packages
{
    public static class OutputVariables
    {
        ...
        public static async Task AreSet()
        {
            ...
            // assert
            Assert.Contains("MinVer: [output] MinVerVersion=2.3.4-alpha.5+build.6", @out);
            ...
            Assert.Contains("MinVer: [output] MinVerPreRelease=alpha.5", @out);
            ...
            Assert.Contains("MinVer: [output] PackageVersion=2.3.4-alpha.5+build.6", @out);
            Assert.Contains("MinVer: [output] Version=2.3.4-alpha.5+build.6", @out);
        }
    }
}
