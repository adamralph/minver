...
namespace MinVerTests.Lib
{
    public static class MinMajorMinor
    {
        ...
        public static async Task NoCommits()
        {
            ...
            // act
            var actualVersion = Versioner.GetVersion(path, default, default, new MajorMinor(1, 2), default, default, default, default);
        ...
        public static async Task Tagged(string tag, int major, int minor, string expectedVersion, bool isRedundant)
        {
            ...
            // act
            var actualVersion = Versioner.GetVersion(path, default, default, new MajorMinor(major, minor), default, default, default, logger);
        ...
        public static async Task NotTagged()
        {
            ...
            // act
            var actualVersion = Versioner.GetVersion(path, default, default, new MajorMinor(1, 0), default, default, default, default);
