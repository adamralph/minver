...
"
            ...
            "When the version is determined for every commit"
                .x(c =>
                {
                    ...
                    foreach (var commit in repo.Commits)
                    {
                        ...
                        var version = Versioner.GetVersion(repo.Using(c), default, default, default, new []{"alpha","0"}, new TestLogger());
        ...
        public static void EmptyRepo(string path, Repository repo, Version version)
        {
            ...
            "When the version is determined"
                .x(() => version = Versioner.GetVersion(repo, default, default, default, new []{"alpha","0"}, new TestLogger()));
